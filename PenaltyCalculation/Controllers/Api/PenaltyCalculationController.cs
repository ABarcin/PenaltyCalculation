...
namespace PenaltyCalculation.Controllers.Api
{
    ...
    public class PenaltyCalculationController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<ResultModel> Post(int countryId,DateTime checkedDate,DateTime returnDate)
        {

            CalculationModel model = new CalculationModel();
            model.SelectedCountryId = countryId;
            var checkedOutDate = checkedDate;
            var returnedDate = returnDate.AddDays(1);
